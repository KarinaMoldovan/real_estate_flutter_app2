...
import 'package:first/features/home/ui/mobile/house_property_widget.dart';
import 'package:first/models/house_model.dart';
import 'package:first/utils/common/constants.dart';
import 'package:first/utils/widgets/custom_button.dart';
...
class ItemDetailScreen2d extends StatefulWidget {
  final House house;
  final int imgPathIndex;

  const ItemDetailScreen2d({Key? key, required this.house, required this.imgPathIndex}) : super(key: key);

  @override
  State<ItemDetailScreen2d> createState() => _ItemDetailScreenState();
}

class _ItemDetailScreenState extends State<ItemDetailScreen2d> {
